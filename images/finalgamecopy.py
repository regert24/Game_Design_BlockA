...
Menu_messages=["Instructions", "Level 1", "Level 2", "Settings",  " ", "Exit"]
...
lava2=py.image.load('images\\lavaspritetest-L2.png')
rock2=py.image.load('images\\rockspritetest-L2.png')
walkCount = 0
...
def level1_game():
    ...
    while run:
        ...
        if x >= 120 and x<=180 and y>=200:
            win.blit(youlose, (0,0))
            py.display.update()
            py.time.delay(500)


        if x >= 325 and x<=385 and y>=200:
            win.blit(youlose, (0,0))
            py.display.update()
            page=losepage
        if x >= 535 and x<=595 and y>=200:
            win.blit(youlose, (0,0))
            py.display.update()
            page=losepage
...
def level2_game():
    ...
    while run:
        ...
        win.blit(lava, (155-5,310))
        win.blit(rock, (0,310-95))
        win.blit(lava, (370-15-105,310))
        win.blit(rock2, (200,310-95))
        win.blit(lava, (350,310))
        win.blit(rock2, (430-20-105,310-95))
        win.blit(rock2, (400, 310-95))
        win.blit(lava, (445,310))
        win.blit(rock2, (505, 310-95))
        win.blit(lava, (550,310))
        win.blit(rock, (610, 310-95))
        win.blit(rock, (750, 310-95))
        ...
        if x >= 650:
            ...
            py.display.update()
            page=winpage
        if x >= 115 and x<=165 and y>=205:
            win.blit(youlose, (0,0))
            py.display.update()
            py.time.delay(500)

        if x >= 220 and x<=306-30 and y>=200:
            win.blit(youlose, (0,0))
            py.display.update()
            page=losepage
        if x >= 350-30 and x<=400-30 and y>=200:
            win.blit(youlose, (0,0))
            py.display.update()
            page=losepage
        if x >= 445-30 and x<=505-30 and y>=200:
            win.blit(youlose, (0,0))
            py.display.update()
            page=losepage
        if x >= 550-30 and x<=610-30 and y>=200:
            win.blit(youlose, (0,0))
            py.display.update()
            page=losepage
    ...
    if eve.type==py.MOUSEBUTTONDOWN:
        ...
        if page==Mainmenu:
            if mouse_pos[0]>=70 and mouse_pos[0]<=230 and mouse_pos[1]>=y_min and mouse_pos[1]<=y_max:
                ...
                displayText("Use the arrow keys to move", 240)
                displayText("Use the space bar to jump from rock to rock", 280)
            ...
            if mouse_pos[0]>=70 and mouse_pos[0]<=230 and mouse_pos[1]>=y_min4 and mouse_pos[1]<=y_max4:
                ...
                displayTitle("Back", height-100)
                page=settings
            elif mouse_pos[0]>=70 and mouse_pos[0]<=230 and mouse_pos[1]>=690 and mouse_pos[1]<=712:
                    py.quit()
        if page == settings or windowsettings:
            if mouse_pos[0]>=320 and mouse_pos[0]<=485 and mouse_pos[1]>=height-100 and mouse_pos[1]<=height:
                win.fill(currentBackColor)
                displayTitle("Menu", 40)
                displayMenu(Menu_messages)
